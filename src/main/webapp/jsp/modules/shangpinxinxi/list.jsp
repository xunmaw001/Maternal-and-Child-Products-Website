...
<body>
						...
						<div class="widget-area-2 lochana-box-shadow">
							...
							<div class="table-responsive mb-3">
								<div class="col-sm-12">
																																																																															<label>
												商品类别
												<select name="shangpinleibie" id="shangpinleibieSelect" class="form-control form-control-sm" aria-controls="tableId">
																									</select>
											</label>
																																																																																																				<label>
												品牌
												<input type="text" id="pinpaiSearch" class="form-control form-control-sm" placeholder="" aria-controls="tableId">
											</label>
												...
												<div class="custom-control custom-checkbox">
													...
													<label class="custom-control-label" for="select-all"></label>
																																						...
																																						<th onclick="sort('shangpinbianhao')">商品编号<i id="shangpinbianhaoIcon" class="fa fa-sort"></i></th>
																																																			...
																																																			<th onclick="sort('shangpinleibie')">商品类别<i id="shangpinleibieIcon" class="fa fa-sort"></i></th>
																													...
																													<th>图片</th>
																																																			...
																																																			<th onclick="sort('shangpinjieshao')">商品介绍<i id="shangpinjieshaoIcon" class="fa fa-sort"></i></th>
	...
	<script>
		...
		function search(){
			searchForm = { key: ""};
																							var shangpinleibieIndex = document.getElementById("shangpinleibieSelect").selectedIndex;
				var shangpinleibieOptions = document.getElementById("shangpinleibieSelect").options;
				var shangpinleibieSelectedOption = shangpinleibieOptions[shangpinleibieIndex]
				if(shangpinleibieSelectedOption.text != null && shangpinleibieSelectedOption.text != ''){
					searchForm.shangpinleibie = "%" + shangpinleibieSelectedOption.text + "%";
				}
        ...
        function getDataList() {
			http("shangpinxinxi/page","GET",{
				...
				sort: sortColumn,
				order: sortOrder,
																																								shangpinleibie : searchForm.shangpinleibie,	
			...
			row.appendChild(checkbox)
							...
							var shangpinbianhaoCell  = document.createElement('td');
									...
									row.appendChild(shangpinmingchengCell);
				            				var shangpinleibieCell  = document.createElement('td');

												  shangpinleibieCell.innerHTML = item.shangpinleibie; 
                
									row.appendChild(shangpinleibieCell);
				  ...
				  tupianCell.appendChild(tupianImg);
									...
									row.appendChild(pinpaiCell);
				            				var shangpinjieshaoCell  = document.createElement('td');
												  ...
												  //如果图文详情包含图片
				  if(item.shangpinjieshao && item.shangpinjieshao.indexOf('img') != -1){
					//暂时只考虑图片+文字 和 文字+图片的情况
					var beginIndex = item.shangpinjieshao.indexOf('<img');
					var endIndex = item.shangpinjieshao.indexOf('>');				
					shangpinjieshaoCell.innerHTML = item.shangpinjieshao.substring(beginIndex, endIndex+1).replace("img","img width='100' height='100'");				
				  }else{
				  	 if(item.shangpinjieshao != null && item.shangpinjieshao != "" && item.shangpinjieshao.length >= 11){
				  		shangpinjieshaoCell.innerHTML = item.shangpinjieshao.substring(0, 10) + "..."; 
				  	}else{
				  		shangpinjieshaoCell.innerHTML = item.shangpinjieshao;
				 	}
				  }
				  

                
									row.appendChild(shangpinjieshaoCell);
		...
		function detail(id){
			...
			window.location.href = "info.jsp";
																			...
																			function shangpinleibieSelect(){
					//填充下拉框选项
					http("option/shangpinfenlei/shangpinleibie","GET",{},(res)=>{
						if(res.code == 0){
							shangpinleibieOptions = res.data;
							var nullOption = document.createElement('option');
							var shangpinleibieSelect = document.getElementById('shangpinleibieSelect');
							shangpinleibieSelect.appendChild(nullOption);
							for(var i=0;i<shangpinleibieOptions.length;i++){
								var shangpinleibieOption = document.createElement('option');
								shangpinleibieOption.setAttribute('name','shangpinleibieOption');
								shangpinleibieOption.setAttribute('value',shangpinleibieOptions[i]);
								shangpinleibieOption.innerHTML = shangpinleibieOptions[i];
								shangpinleibieSelect.appendChild(shangpinleibieOption);
							}
						}
					});
				}
