        ...
        <div class="ng-inmod-ini">
          <div class="ng-fault ng-container">
            <div class="ng-inmod-the ng-container ng-bg-assist">
              ...
              <span class="ng-inmod-the-cn" aos="fade-down">商品信息展示</span>
          ...
          <div class="ng-incontlst ng-fault ng-container ng-ai-drive1_map" aos="fade-up">
            <div class="ng-incontlst-doc ng-incontlst-doc-show">
              <div class="row">
                <div class="ng-incontlst-col" v-for="(item,index) in shangpinxinxiList" v-bind:key="index">
                  <div class="ng-incontlst-bor">
                    <div class="ng-incontlst-img ng-oa ng-fault">
                      <a href="javascript:void(0);" @click="jump('../shangpinxinxi/detail.jsp?id='+item.id)">
                        <img :src="item.tupian?item.tupian.split(',')[0]:''" />
                      </a>
                    </div>
                    <div class="ng-fault ng-container">
                      <div class="ng-incontlst-tit">
                        <p>{{item.shangpinmingcheng}}</p>
                        <p style="color: red;" v-if="item.price">{{item.price}} RMB</p>
                        <span></span>
                      </div>
                      <a href="javascript:void(0);" class="ng-incontlst-ikk" @click="jump('../shangpinxinxi/detail.jsp?id='+item.id)">查看详情</a>
                    </div>
                  </div>
                </div>
              </div>
