        ...
        <div class="ng-inmod-ini">
          <div class="ng-fault ng-container">
            <div class="ng-inmod-the ng-container ng-bg-fff">
              ...
              <span class="ng-inmod-the-cn" aos="fade-down">商品信息评论表展示</span><span class="ng-inmod-the-en" aos="fade-up">DATA SHOW</span>
            </div>
              ...
              <ul>
                <li v-for="(item,index) in dataList" v-bind:key="index">
                  <div class="ng-prslist-doc">
                    <div class="ng-prslist-img" @click="jump('../discussshangpinxinxi/detail.jsp?id='+item.id)">
