		...
		<div id="app">
			...
			<div class="data-add-container">
				...
				<form class="layui-form layui-form-pane" lay-filter="myForm">
                        ...
                        <div class="layui-input-block">
                            <select name="shangpinleibie" id="shangpinleibie" lay-filter="shangpinleibie">
                                <option value="">请选择</option>
                                <option v-for="(item,index) in shangpinleibie" v-bind:key="index" :value="item">{{item}}</option>
                            </select>
                        </div>
                    </div>
                                                                                <div class="layui-form-item" pane>
						...
						<div class="layui-input-block">
							<input v-model="detail.shangpinguige" type="text" name="shangpinguige" id="shangpinguige" autocomplete="off" class="layui-input">
						</div>
					</div>
                                                                                <div class="layui-form-item" pane>
						...
						<div class="layui-input-block">
							<input v-model="detail.onelimittimes" type="text" name="onelimittimes" id="onelimittimes" autocomplete="off" class="layui-input">
						</div>
					</div>
                                                                                <div class="layui-form-item" pane>
						<label class="layui-form-label">库存：</label>
						<div class="layui-input-block">
							<input v-model="detail.alllimittimes" type="text" name="alllimittimes" id="alllimittimes" autocomplete="off" class="layui-input">
						</div>
					</div>
					...
					if (res.data.list.length > 0) {
						...
						carousel.render({
							...
							indicator: "none"
                																								...
                																								http.request(`option/shangpinfenlei/shangpinleibie`,'get',{},(res)=>{
					vue.shangpinleibie = res.data
				});
																								// 上传图片
